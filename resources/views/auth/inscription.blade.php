...
<head>
  ...
  <title>Inscription - SMART-HEALTH</title>
...
<div class="auth-container">
  <div class="auth-card fade-in-up">
    ...
    <div class="logo-container fade-in-up delay-1">
      ...
      <div class="page-title text-center">Inscription Patient</div>
    </div>
    ...
    <form method="POST" action="{{ route('register.submit') }}" class="fade-in-up delay-2">
      @csrf
        ...
        <div class="col-12">
          <div class="form-group">
            ...
            <textarea name="antecedents" 
                      ...
                      class="form-control" 
                      rows="3" 
                      placeholder="Décrivez vos antécédents médicaux (optionnel)">{{ old('antecedents') }}</textarea>
          </div>
        </div>
      </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (submitBtn) {
    submitBtn.addEventListener('click', function(e) {
      ...
      setTimeout(() => {
        this.innerHTML = '<i class="bi bi-hourglass-split me-2"></i>Création du compte...';
        this.disabled = true;
      }, 100);
    });
  }
