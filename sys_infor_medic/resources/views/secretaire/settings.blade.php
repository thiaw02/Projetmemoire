      ...
      <div class="settings-hero">
        <div class="hero-content">
          <div class="hero-main">
            ...
            <div class="hero-text">
              <h1>Paramètres Secrétaire</h1>
              <p>Gérez vos informations administratives et d'accueil</p>
          ...
          <div class="hero-actions">
            <a href="{{ route('secretaire.dashboard') }}" class="btn-hero-back">
            ...
            <div class="card-body-modern">
              <form method="POST" action="{{ route('profile.update') }}" class="modern-form">
                ...
                <div class="form-grid">
                  ...
                  <div class="input-group-modern">
                    ...
                    <input type="email" name="email" class="input-modern" 
                           ...
                           placeholder="secretariat@clinic.com" required>
                  </div>
                ...
                <div class="form-actions-modern">
                  <button type="submit" class="btn-modern btn-secretary-personal">
              ...
              <form method="POST" action="{{ route('profile.update') }}" class="modern-form">
                ...
                <div class="form-grid professional-grid">
                  <div class="input-group-modern">
                    ...
                    <input type="text" name="poste" class="input-modern" 
                           value="{{ old('poste', auth()->user()->poste) }}" 
                           placeholder="Secrétaire médicale, Assistante, etc.">
                  </div>
                  ...
                  <div class="input-group-modern">
                    ...
                    <input type="text" name="service" class="input-modern" 
                           ...
                           placeholder="Accueil, Secrétariat médical, etc.">
                  </div>
                  ...
                  <div class="input-group-modern">
                    ...
                    <input type="text" name="etablissement" class="input-modern" 
                           ...
                           placeholder="Cabinet médical ou clinique">
                  </div>
                  ...
                  <div class="input-group-modern full-width">
                    <label class="label-modern">
                      ...
                      <span>Responsabilités principales</span>
                    </label>
                    <textarea name="responsabilites" class="input-modern" rows="3" 
                              placeholder="Ex: Gestion agenda, Accueil patients, Gestion dossiers, Téléphone...">{{ old('responsabilites', auth()->user()->responsabilites) }}</textarea>
                  </div>
                  ...
                  <div class="input-group-modern full-width">
                    ...
                    <textarea name="horaires" class="input-modern" rows="3" 
                              placeholder="Ex: Lun-Ven 8h-17h, Pause déjeuner 12h-13h">{{ old('horaires', auth()->user()->horaires) }}</textarea>
                  </div>
                </div>
                
                <div class="form-actions-modern">
                  <button type="submit" class="btn-modern btn-secretary-professional">
          ...
          <div class="modern-card">
            <div class="card-header-modern">
              ...
              <div class="header-content">
                ...
                <p>Protection des données administratives</p>
              </div>
            </div>
            <div class="card-body-modern">
              <form method="POST" action="{{ route('profile.password.update') }}" class="modern-form">
                ...
                <div class="security-tips">
                  <h6><i class="bi bi-info-circle me-2"></i>Sécurité du secrétariat médical</h6>
                  <ul>
                    <li>Protégez l'accès aux plannings et dossiers patients</li>
                    <li>Gardez vos identifiants confidentiels</li>
                    <li>Respectez la confidentialité des informations</li>
                    <li>Verrouillez votre session lors des pauses</li>
                  </ul>
                </div>
          ...
          <div class="modern-card">
            <div class="card-header-modern">
              ...
              <div class="header-content">
                ...
                <p>Photo d'accueil professionnel</p>
              </div>
            </div>
            <div class="card-body-modern">
              @php
                ...
                <div class="current-avatar">
                  <div class="avatar-display-modern">
                    ...
                    <div class="avatar-details">
                      <h6>{{ $user->name }}</h6>
                      <p>Photo visible à l'accueil et dans le système</p>
                    </div>
                  </div>
                </div>
...
<style>
  /* Variables CSS pour secrétaire */
  :root {
    --primary-color: #8b5cf6;
    --primary-light: #8b5cf620;
    --primary-hover: #8b5cf615;
  }
  
  /* Boutons spécialisés secrétaire */
  .btn-modern.btn-secretary-personal {
    background: linear-gradient(135deg, #06b6d4, #0891b2);
    color: white;
    box-shadow: 0 4px 15px rgba(6, 182, 212, 0.3);
  }
  
  .btn-modern.btn-secretary-personal:hover {
    background: linear-gradient(135deg, #0891b2, #0e7490);
    transform: translateY(-3px);
    color: white;
  }
  
  .btn-modern.btn-secretary-professional {
    background: linear-gradient(135deg, #8b5cf6, #7c3aed);
    color: white;
    box-shadow: 0 4px 15px rgba(139, 92, 246, 0.3);
  }
  
  .btn-modern.btn-secretary-professional:hover {
