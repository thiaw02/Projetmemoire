      ...
      <div class="settings-hero">
        <div class="hero-content">
          <div class="hero-main">
            ...
            <div class="hero-text">
              <h1>Paramètres Médecin</h1>
              <p>Gérez vos informations médicales et professionnelles</p>
              <div class="hero-stats">
                <div class="stat-item">
                  <i class="bi bi-heart-pulse"></i>
                  <span>Professionnel médical</span>
                </div>
                <div class="stat-item">
                  <i class="bi bi-shield-check"></i>
                  <span>Praticien certifié</span>
                </div>
              </div>
            </div>
          </div>
          <div class="hero-actions">
            <a href="{{ route('medecin.dashboard') }}" class="btn-hero-back">
                ...
                <div class="form-grid">
                  ...
                  <div class="input-group-modern">
                    ...
                    <input type="email" name="email" class="input-modern" 
                           ...
                           placeholder="dr.nom@clinic.com" required>
                  </div>
                </div>
                
                <div class="form-actions-modern">
                  <button type="submit" class="btn-modern btn-doctor-personal">
          ...
          <div class="modern-card">
            <div class="card-header-modern">
              ...
              <div class="header-content">
                ...
                <p>Détails de votre pratique médicale</p>
              </div>
            </div>
            <div class="card-body-modern">
              <form method="POST" action="{{ route('profile.update') }}" class="modern-form">
                ...
                <div class="form-grid medical-grid">
                  ...
                  <div class="input-group-modern">
                    ...
                    <input type="text" name="cabinet" class="input-modern" 
                           ...
                           placeholder="Nom du cabinet ou clinique">
                  </div>
                  ...
                  <div class="input-group-modern full-width">
                    ...
                    <textarea name="horaires" class="input-modern" rows="3" 
                              placeholder="Ex: Lun-Ven 9h-17h, Sam 9h-13h. Consultations sur RDV">{{ old('horaires', auth()->user()->horaires) }}</textarea>
                  </div>
                </div>
                
                <div class="form-actions-modern">
                  <button type="submit" class="btn-modern btn-doctor-medical">
          ...
          <div class="modern-card">
            <div class="card-header-modern">
              ...
              <div class="header-content">
                ...
                <p>Protection de vos données médicales</p>
              </div>
            </div>
            <div class="card-body-modern">
              <form method="POST" action="{{ route('profile.password.update') }}" class="modern-form">
                ...
                <div class="security-tips">
                  <h6><i class="bi bi-info-circle me-2"></i>Sécurité médicale renforcée</h6>
                  <ul>
                    <li>Utilisez un mot de passe robuste pour protéger les données patients</li>
          ...
          <div class="modern-card">
            <div class="card-header-modern">
              ...
              <div class="header-content">
                ...
                <p>Photo professionnelle pour vos patients</p>
              </div>
            </div>
            <div class="card-body-modern">
              @php
                ...
                <div class="current-avatar">
                  <div class="avatar-display-modern">
                    ...
                    <div class="avatar-details">
                      <h6>{{ $user->name }}</h6>
                      <p>Photo professionnelle visible par vos patients</p>
                    </div>
                  </div>
                </div>
...
<style>
  /* Variables CSS pour médecin */
  :root {
    --primary-color: #dc2626;
    --primary-light: #dc262620;
    --primary-hover: #dc262615;
  }
  
  /* Boutons spécialisés médecin */
  .btn-modern.btn-doctor-personal {
    background: linear-gradient(135deg, #3b82f6, #1d4ed8);
    color: white;
    box-shadow: 0 4px 15px rgba(59, 130, 246, 0.3);
  }
  
  .btn-modern.btn-doctor-personal:hover {
    background: linear-gradient(135deg, #1d4ed8, #1e40af);
    transform: translateY(-3px);
    color: white;
  }
  
  .btn-modern.btn-doctor-medical {
    background: linear-gradient(135deg, #dc2626, #991b1b);
    color: white;
    box-shadow: 0 4px 15px rgba(220, 38, 38, 0.3);
  }
  
  .btn-modern.btn-doctor-medical:hover {
